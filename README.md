...
I wanted to explore web-scraping techniques using Python while also solving the real problem of accessing LoL WR information quickly without a language and time barrier. Now, I can fetch matchup data without exceeding the loading screen time or opening up 3 websites all at once.

The sequence: user inputs -> data collection -> HMTL parsing -> decode some stuff from Chinese -> data processing -> formatted -> output
...
### Example output
<img width="568" height="359" alt="Screenshot 2569-09-06 at 16 38 09" src="https://github.com/user-attachments/assets/fa71203b-c275-4963-8c1c-fcdfdc80a7f7" />
